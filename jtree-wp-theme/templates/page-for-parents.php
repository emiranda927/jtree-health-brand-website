...
<main id="main">
  ...
  <section class="section section--intro">
    <div class="container container--narrow">
      <span class="jth-eyebrow">For parents and caregivers</span>
      <h1 class="jth-display-l">You don't have to figure this out <em class="jth-emph">alone.</em></h1>
      <p class="jth-body-l jth-lede">Most families come to us already exhausted. Outpatient therapy isn't holding. School is harder than it should be. The teen you love is still struggling, and you're running out of ideas.</p>
    </div>
  </section>

  <section class="section">
    <div class="container container--narrow">
      <h2 class="jth-h2 jth-mb-4">What to expect from us</h2>
      <ul class="jth-list">
      ...
      <p class="jth-body jth-mb-7">If you're closer to a crisis than a question, call <strong>988</strong> right now. They are kind, fast, and they answer. We'll be here when you're ready.</p>
  ...
  <section class="section section-bg-cream-2">
    <div class="container container--prose">
      <span class="jth-eyebrow">Where you fit in</span>
      <h2 class="jth-h2 jth-mb-4">Most fights with your teen aren't about the topic. They're about the pattern.</h2>
      <p class="jth-body-l jth-mb-4">One of the modules in our 12-week IOP is called <em>Walking the Middle Path</em>. A full week of it is dedicated to parent-teen escalation patterns and how to repair after a rupture &mdash; because that loop is what most families are actually stuck in, not the curfew or the homework or the phone.</p>
      <p class="jth-body-l jth-mb-4">We teach your teen to notice the early signs in their own body that escalation is starting. We also teach them validation, repair, and how to stay regulated when a parent is dysregulated. Then we bring you into family sessions every two weeks to practice the other side of that loop.</p>
      <p class="jth-body-l">You don't have to be the perfect parent. You just have to be in the room.</p>
    </div>
  </section>

  <section class="section">
    <div class="container container--prose">
      <span class="jth-eyebrow">What your teen actually learns</span>
      <h2 class="jth-h2 jth-mb-4">Twelve weeks of skills, in plain English.</h2>
      <p class="jth-body jth-mb-4">The IOP follows a 12-week arc rooted in Dialectical Behavior Therapy (DBT) and polyvagal theory. It builds on itself, week by week:</p>
      <ul class="jth-list">
      ...
      <p class="jth-body-s jth-text-muted">If a skill name sounds clinical, that's because it is. The reason we name them is so your teen can come home and tell you "I used TIPP today" &mdash; and you can know what they mean.</p>
    </div>
  </section>
