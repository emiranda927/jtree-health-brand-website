...
<main id="main" class="admissions-section">
  ...
  <section class="admissions-grid">
    <div>
      <div class="form-card">
        <span class="jth-eyebrow">&sect; Admissions</span>
        ...
        <p class="jth-body-s jth-text-muted form-card__sub">In-network with BlueCross BlueShield, Cigna, Aetna, and Tricare. We verify your coverage before your teen's first day.</p>
    ...
    <aside>
      ...
      <div class="contact-card">
        ...
        <p class="jth-body-s jth-mt-3">After hours? Leave a message and we'll call you back the next business day. In a crisis, call or text <a href="tel:988"><strong>988</strong></a>.</p>
      </div>
    </aside>
  </section>
